...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    new JoystickButton(controller2, 1).whenActive(m_IndexOn);
    new JoystickButton(controller2, 2).whenActive(m_IndexOff);
    new JoystickButton(controller2, 5).whenInactive(m_RunConveyor);
    new JoystickButton(controller2, 5).whileHeld(m_ReverseConveyor);
  }
